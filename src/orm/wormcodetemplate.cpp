...
void WormCodeTemplate::setUri( const std::string& uri )
{
    ...
    else if(tmp.compare("class_declaration_base.tpl") == 0)
        _type=ClassDeclarationBase;
    else if(tmp.compare("class_definition.tpl") == 0)
        _type=ClassDefinition;
    else if(tmp.compare("class_definition_base.tpl") == 0)
        _type=ClassDefinitionBase;
    else if(tmp.compare("edit_view_declaration.tpl") == 0)
        _type=EditViewDeclaration;
    else if(tmp.compare("edit_view_declaration_base.tpl") == 0)
        _type=EditViewDeclarationBase;
    else if(tmp.compare("edit_view_definition.tpl") == 0)
        _type=EditViewDefinition;
    else if(tmp.compare("edit_view_definition_base.tpl") == 0)
        _type=EditViewDefinitionBase;
    else if(tmp.compare("list_view_declaration.tpl") == 0)
        _type=ListViewDeclaration;
    else if(tmp.compare("list_view_declaration_base.tpl") == 0)
        _type=ListViewDeclarationBase;
    else if(tmp.compare("list_view_definition.tpl") == 0)
        _type=ListViewDefinition;
    else if(tmp.compare("list_view_definition_base.tpl") == 0)
